...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-md-12">
           	<div class="card">
               	<div class="header">
                   	<h4 class="title">테이블도 뭐 그렇게 어렵진 않아요.<c:out value= "${vo.age}"></c:out> <c:out value= "${vo.age2}"></c:out></h4>
                   	<p class="category">기본 확실하게 다져서 갑시다~ <c:out value= "${welcomeWeb1VO.age}"></c:out> <c:out value= "${welcomeWeb1VO.age2}"></c:out></p>
               	</div>
